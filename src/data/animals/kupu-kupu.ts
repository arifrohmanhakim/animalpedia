...
export const kupu_kupu: Animal = {
  ...
  story: "Halo! Aku Kupu-kupu, Butterfly! Kupu-kupu merasakan rasa dengan kakinya! sayap kupu-kupu transparan, warnanya berasal dari pantulan cahaya. ada lebih dari 20.000 jenis kupu-kupu di dunia. Ayo bermain denganku!",
  funFacts: [
